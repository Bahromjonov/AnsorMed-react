  ...
  return (
    <div className='bg-[#0EB4C1]'>
      <div className='containerr flex justify-between'>
        <div className='max-w-[500px] pt-32  '>
          <h2 className='text-white mb-4 text-3xl font-bold leading-10'>Tabiiy davolash usullari yordamida kasalliklardan xalos bo’ling.</h2>
          ...
          {/* Hero button */}
          <button className='bg-[#DE2E54] py-3  px-6 rounded-lg border-transparent border-red border-2 text-lg text-white hover:bg-white  hover:border-red-500 hover:text-red-500'>QABULGA YOZILISH</button>
        </div>
          {/* Bratan */}
          <div className='pt-8'>
